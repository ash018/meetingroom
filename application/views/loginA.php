...
<body>
<form action ="<?php echo base_url();?>authenticate/login" method="POST" autocomplete="off">
...
<div class="pen-title">
  <h1>Meeting Room Booking</h1><span>ACI concern <i class='fa fa-bookmark-o'></i>  </span>
</div>
<!-- Form Module-->
<div class="module form-module">
  ...
  <div class="form">
    <h2>Login to your account</h2>
      ...
      <input type="text" name="empcode" id="email" placeholder="Username" autocomplete="off"  />
      <input type="password" name="password" id="password" placeholder="Password" autocomplete="off"/>
	  <input type="submit" value="Login" class="buttons" name="login" ="off" >
